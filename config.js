...
// make true if you want auto reply on status 
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY SILA-MD 🤍*",
...
OWNER_NAME: process.env.OWNER_NAME || "SILA",
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ Sila Md*",
// add bot owner name    
ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/jwmx1j.jpg",
// add img for alive msg
LIVE_MSG: process.env.LIVE_MSG || "> PERFECT AND SAFE  *SILA-MD*⚡",
// add alive msg here 
